...
export enum DICT_TYPE {
  ...
  // ========== WTY - 维保模块  ==========
  WARRANTY_AUDIT = 'warranty_audit', // 维保 设备状态
  WARRANTY_DEVICE_STATUS = 'warranty_device_status', // 维保 设备状态
  WARRANTY_DEVICE_TYPE_STATUS = 'warranty_device_type_status', // 维保 设备类型状态
  WARRANTY_COMPONENT_STATUS = 'warranty_component_status', // 维保 配件状态
  WARRANTY_COMPONENT_UNIT = 'warranty_component_unit', //维保 配件单位
  WARRANTY_DEPT_ADDRESS_TYPE = 'warranty_dept_address_type', //维保 地址类型
  WARRANTY_DEPT_ADDRESS_IS_DEFAULT = 'warranty_dept_address_is_default', //维保 地址是否默认
  WARRANTY_ORDER_TYPE = 'warranty_order_type', //维保 工单类型
  WARRANTY_ORDER_STATUS = 'warranty_order_status', //维保 工单状态
  WARRANTY_ORDER_PRIORITY = 'warranty_order_priority', //维保 工单优先级
